<%-- 
    Document   : index
    Created on : 10-Abril-2018, 23:24:59
...
<body>
    ...
    <!-- MENU DINAMICO DE CATEGORIAS IZQUIERDO -->   
        <section>
            <div class="container">
		<div class="row">
                    <div class="col-sm-3">
			<div class="left-sidebar">
						...
						<h4 class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordian" href="#<%--= codigo --%><jsp:expression>codigo</jsp:expression>">
                                            ...
                                            <div id="<%--= codigo --%><jsp:expression>codigo</jsp:expression>" class="panel-collapse collapse">
						<div class="panel-body">
                                                    <ul>                
                                                        <%
                                                            ArrayList<Categoria> listaSub=CategoriaDao.listarSubCategorias(codigo); 
                                                        %>
                                                        <%-- 
                                                        ...
                                                        <jsp:scriptlet>
                                                            ...
                                                            <li>
                                                                <a href="#"><%--= listaSub.get(isub).getNombre()--%><jsp:expression>listaSub.get(isub).getNombre()</jsp:expression></a>
                                                            </li>
                                                        <%-- } --%>
                                                        <jsp:scriptlet>
                                                            }
    ...
    <!-- FIN DE MENU DINAMICO DE CATEGORIAS IZQUIERDO -->   
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2018 . Todos los derechos reservados.</p>
					<p class="pull-right">Curso diseñado por <span><a target="_blank" href="#">Juan Luis Goldaracena</a></span></p>
				</div>
			</div>
		</div>
